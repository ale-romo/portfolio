...
const LeftColumn = ({ children }: Props) => {
  return (
    <section className="flex flex-col justify-between w-full md:w-2/5 items-start bg-slate-200 p-5 pr-0 border-r border-black">
        {children}
      <footer className="flex gap-4 items-center w-full pr-5">
