...
const Collaborators = ({ collaborators }: { collaborators: Collaborator[] }) => <ul className="flex flex-wrap justify-start">
     <h4 className="flex text-xs w-full">Collaboradores:</h4>
