...
const Technologies = ({ technologies }: { technologies: Technology[] }) => <ul className="flex flex-wrap justify-left gap-1 p-3 bg-slate-100 hover:bg-slate-200/70 rounded w-full">
    <h4 className="text-xs text-gray-400 w-full">Tecnologías:</h4>
