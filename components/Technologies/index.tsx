...
const Technologies = ({ technologies }: { technologies: Technology[] }) => <ul className="flex flex-wrap justify-left gap-1 gap-y-2 p-3 bg-slate-300/60 hover:bg-slate-100/50 rounded w-full">
