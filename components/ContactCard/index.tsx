...
const ContactCard = () => (<section className="flex gap-4 items-center justify-center w-full md:pr-5">
    ...
    <a href="mailto:alejandro@mintitmedia.com" target="_blank" className="flex gap-2 items-center bg-black font-heading text-white/80 hover:text-white border rounded-md px-3 py-2"><SpaceInvader size={2} slug="Collaborate" color="#ffffff" />Let&apos;s work together!</a>
  </section>
);
